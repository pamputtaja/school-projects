...
public:
    ...
    // tyhjentää laudan ja alustaa uuden laudan uutta peliä varten
    void clear_board();

    // funktio, jolla päästään käsiksi moves attribuuttiin siirtojen määrän
    // laskemiseksi
    void report_move();

    // palauttaa kokonaislukuna siirtojen määrän
    int get_moves();

    // palauttaa kokonaislukuna pisteet
    int get_points();

    // pisteiden vähennysfunktio
    void deduct_points();
