-- VHDL Entity alien_game_lib.c2_t1_hello_led_combined.symbol
--
-- Created:
--          by - koistin3.UNKNOWN (HTC219-304-SPC)
--          at - 14:59:38 22.09.2023
--
...
ENTITY c2_t1_hello_led_combined IS
   PORT( 
...
END c2_t1_hello_led_combined ;

--
-- VHDL Architecture alien_game_lib.c2_t1_hello_led_combined.struct
--
-- Created:
--          by - koistin3.UNKNOWN (HTC219-304-SPC)
--          at - 14:59:37 22.09.2023
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
...
ARCHITECTURE struct OF c2_t1_hello_led_combined IS
   ...
   END COMPONENT;
   COMPONENT c2_t1_hello_led_static
   PORT (
      color_BGR : OUT    std_logic_vector (23 DOWNTO 0);
      x_coord   : OUT    std_logic_vector (7 DOWNTO 0);
      y_coord   : OUT    std_logic_vector (7 DOWNTO 0)
   ...
   FOR ALL : c2_t1_hello_led_static USE ENTITY alien_game_lib.c2_t1_hello_led_static;
   -- pragma synthesis_on
...
BEGIN
   ...
   u_3combo_proc: PROCESS(y_coord2, y_coord1, sw0)
   BEGIN
      CASE sw0 IS
   ...
   u_4combo_proc: PROCESS(color_BGR2, color_BGR1, sw0)
   BEGIN
      CASE sw0 IS
